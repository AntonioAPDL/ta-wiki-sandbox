...
This guide helps TAs grade consistently and fairly.
...
## Before you submit grades
- Spot-check totals and make sure late penalties are applied.
...
- Which question they want reviewed.
- The expected rubric line.
- A brief explanation (2-4 sentences).

Do not regrade after the deadline unless the instructor approves.
