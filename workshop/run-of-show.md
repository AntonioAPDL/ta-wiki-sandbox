# Hour 1 Run-of-Show (Facilitator)

## 0-5 min: define success + show README
- Success = every attendee opens 1 PR.
- Show `README.md` and the "What you will do in 60 minutes" list.

## 5-15 min: explain the mental model
- Use the diagram in `README.md`.
- Emphasize: working tree -> staging -> commit -> remote -> PR.
...
- Summarize what a good PR looks like.
- Hand off to Hour 2.
